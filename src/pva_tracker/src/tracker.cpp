...
{
    // ROS_INFO_THROTTLE(1,"POSITION CALLBACK");
    /// ENU frame
...
{
    /// ENU frame
    // ROS_INFO_THROTTLE(1,"VELOCITY CALLBACK");
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber position_sub = nh.subscribe("/quadrotor_pose", 1, positionCallback);
    ros::Subscriber velocity_sub = nh.subscribe("/quadrotor_vel", 1, velocityCallback);
